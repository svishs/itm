...
async def main():
    ...
    # ORM
        ...
        SyncORM.insert_data_in_tables()
        SyncORM.select_managers()
        SyncORM.select_distinct_managers()
        SyncORM.select_best_clients()
        SyncORM.select_emp_with_lazy_orders()
        SyncORM.select_emp_with_joined_orders()
        SyncORM.select_emp_with_selectin_relationship()
        SyncORM.del_from_providers()
        SyncORM.select_providers()
        SyncORM.get_laptop_orders()
        SyncORM.get_laptop_orders_contains_eager()
